...
class CoKrigingSurrogateTest(unittest.TestCase):
    ...
    def test_1d_1fi_cokriging(self):
        ...
        self.assertAlmostEqual(y[0] , mu, places=4)
        self.assertAlmostEqual(.0, sigma, places=4)

        mu, sigma = krig1.predict(new_x)
        self.assertAlmostEqual( -2.0279, mu, places=3)
        self.assertAlmostEqual(1.3408, sigma, places=3)
        ...
        self.assertAlmostEqual( -1.2719, mu, places=3)
        self.assertAlmostEqual(0.0439, sigma, places=3)
    ...
    def test_1d_2fi_cokriging(self):
        ...
        self.assertAlmostEqual( f_expensive(new_x[0]), mu, delta=0.05)
        self.assertAlmostEqual(0., sigma, delta=0.02)
    ...
    def test_2d_1fi_cokriging(self):
        ...
        self.assertAlmostEqual(branin(x[0]), mu, places=5)
        self.assertAlmostEqual(0., sigma, places=5)

        mu, sigma = krig1.predict([5., 5.])
        self.assertAlmostEqual(22, mu, delta=1)
        self.assertAlmostEqual(13, sigma, delta=1)
    ...
    def test_2d_2fi_cokriging(self):
        ...
        self.assertAlmostEqual(26, mu, places=0)
        self.assertAlmostEqual(0.3, sigma, places=0)
        ...
        self.assertAlmostEqual(21.7, mu, places=0)
        self.assertAlmostEqual(2.29, sigma, places=0)
        ...
        mu, sigma = cokrig2.predict([2./3., 1/3.])
        self.assertAlmostEqual(21.01, mu, places=0)
        self.assertAlmostEqual(2.29, sigma, places=0)
