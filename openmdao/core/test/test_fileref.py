...
class FileSrc(Component):
    def __init__(self):
        ...
        self.add_output("bin_dat", FileRef("bin.dat", binary=True))
...
class FilePass(Component):
    def __init__(self):
        ...
        self.add_param("bin_in", FileRef("bin.dat", binary=True))
        self.add_output("ascii_out", FileRef("ascii.out"))
        self.add_output("bin_out", FileRef("bin.out", binary=True))
...
class FileSink(Component):
    def __init__(self):
        ...
        self.add_param("bin_in", FileRef("bin_final.dat", binary=True))
...
class TestFileRef(unittest.TestCase):
    ...
    def test_same_dir(self):
        ...
        self.assertEqual(sink.params['ascii_in'].open('r').read(),
                         "this is line 1\nthis is line 2\nthis is line 3")
