...
class TestComponent(unittest.TestCase):
    ...
    def test_generate_numpydocstring(self):
        ...
        original_string = '\t"""\n\n\tParams\n\t----------\n    x: param  ({\'shape\': 1, \'size\': 1, \'val\': 0.0, \'promoted_name\': \'x\'})\n    y: param  ({\'shape\': (2,), \'size\': 2, \'val\': array([ 0.,  0.]), \'promoted_name\': \'y\'})\n    z : unknown  ({\'pass_by_obj\': True, \'size\': 0, \'val\': -1, \'promoted_name\': \'z\'})\n    s : unknown  ({\'shape\': 1, \'size\': 1, \'state\': True, \'val\': 0.0, \'promoted_name\': \'s\'})\n\n\tOptions\n\t----------\n    force_fd :  bool(False)\n        Set to True to finite difference this system.\n    form :  str(forward)\n        Finite difference mode. (forward, backward, central) You can also set to \'complex_step\' to peform the complex step method if your components support it.\n    step_size :  float(1e-06)\n        Default finite difference stepsize\n    step_type :  str(absolute)\n        Set to absolute, relative\n\n\t"""\n'
