...
class TestComponent(unittest.TestCase):
    ...
    def test_generate_numpydocstring(self):
        ...
        original_string = '\t"""\n\n\tParams\n\t----------\n    x: param ({\'promoted_name\': x, \'shape\': 1, \'size\': 1, \'val\': 0.0})    y: param ({\'promoted_name\': y, \'shape\': (2,), \'size\': 2, \'val\': [ 0.  0.]})    z : unknown ({\'pass_by_obj\': True, \'promoted_name\': z, \'size\': 0, \'val\': -1})    s : unknown ({\'promoted_name\': s, \'shape\': 1, \'size\': 1, \'state\': True, \'val\': 0.0})\n\tOptions\n\t----------\n    force_fd :  bool(False)\n        Set to True to finite difference this system.\n    form :  str(forward)\n        Finite difference mode. (forward, backward, central) You can also set to \'complex_step\' to peform the complex step method if your components support it.\n    step_size :  float(1e-06)\n        Default finite difference stepsize\n    step_type :  str(absolute)\n        Set to absolute, relative\n\n\t"""\n'
