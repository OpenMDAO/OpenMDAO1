...
class TestMPIOpt(MPITestCase):
    ...
    def test_parab_FD(self):
        ...
        driver.add_desvar('p1.x', lower=-100, higher=100)
        driver.add_desvar('p2.x', lower=-100, higher=100)
    ...
    def test_parab_FD_subbed_Pcomps(self):
        ...
        driver = model.driver = pyOptSparseDriver()
        driver.options['optimizer'] = OPTIMIZER
        driver.add_desvar('par.s1.p.x', lower=-100, higher=100)
        driver.add_desvar('par.s2.p.x', lower=-100, higher=100)
        driver.add_objective('sumcomp.sum')
...
class ParallelMPIOptAsym(MPITestCase):
    ...
    def setUp(self):
        ...
        prob.driver.add_desvar('par.ser1.x', lower=-50.0, higher=50.0)
        prob.driver.add_desvar('par.ser2.x', lower=-50.0, higher=50.0)
...
class ParallelMPIOpt(MPITestCase):
    ...
    def setUp(self):
        ...
        prob.driver = pyOptSparseDriver()
        prob.driver.options['optimizer'] = OPTIMIZER
        prob.driver.add_desvar('par.ser1.p1.x', lower=-50.0, higher=50.0)
        prob.driver.add_desvar('par.ser2.p1.x', lower=-50.0, higher=50.0)
