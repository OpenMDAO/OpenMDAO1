...
class ABCDArrayComp(Component):
    ...
    def solve_nonlinear(self, params, unknowns, resids):
        ...
        import sys
        print "solving",self.pathname;sys.stdout.flush();sys.stderr.flush()
        unknowns['c'] = params['a'] + params['b']
        unknowns['d'] = params['a'] - params['b']
        print "done solving",self.pathname;sys.stdout.flush();sys.stderr.flush()
...
class MPITests1(MPITestCase):
    ...
    def test_simple(self):
        ...
        import sys
        print "run done";sys.stdout.flush();sys.stderr.flush()
        ...
        print "test done";sys.stdout.flush();sys.stderr.flush()
